...
<!--
  Edited by Evan Jackson - March 12 2014
  Added MADS namespace and links to MADS_to_solr.xslt, person_mads_to_solr.xslt and project_mads_to_solr.xslt
  Edited by Evan Jackson - March 16 2014
  Added EML and Fraction namespaces and links to fraction_to_solr.xslt and specimen_eml_to_solr.xslt
  Edited by Evan Jackson - March 22 2014
  Re-added fraction namespace, removed specimen_eml_solr.xslt, added link to EML_to_solr.xslt
-->
...
<xsl:stylesheet version="1.0"
  ...
  <xsl:include href="/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex/islandora_transforms/person_mads_to_solr.xslt"/>
  <xsl:include href="/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex/islandora_transforms/project_mads_to_solr.xslt"/>
  <xsl:include href="/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex/islandora_transforms/EML_to_solr.xslt"/>
  <xsl:include href="/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex/islandora_transforms/fraction_to_solr.xslt"/>
